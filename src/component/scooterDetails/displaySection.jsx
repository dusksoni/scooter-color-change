      ...
      <div className="flex flex-col md:gap-x-8 gap-y-8">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex gap-4 ml-auto">
            ...
            />
            <div className="md:text-sm text-xs text-black my-auto">
              Sparkling Green
            </div>
          </div>
        </div>
        ...
        {/* Scooter image with transition effect */}
          ...
          <div className="flex flex-col gap-2.5 ml-auto">
            <div className="flex gap-4 text-[10px]">
              ...
              <div className="flex h-fit">
                <select name="location" id="location" className="focus:outline-none select h-fit my-auto">
